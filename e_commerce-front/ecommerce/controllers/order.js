...
sgMail.setApiKey(
  "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"
);
...
exports.create = (req, res) => {
  ...
  order.save((error, data) => {
    ...
    const emailData = {
      to: "romanyad16@gmail.com", // admin
      from: "noreply@ecommerce.com",
      subject: `A new order is received`,
      html: `
            <h1>Hey Admin, Somebody just made a purchase from RoParts Shop</h1>
