...
1	Mostafa Musab Naveed	Backend Developer 	•	Primary responsibilities 
•	Backend Developer
•	Building API’s
•	Server handling
•	Resources findings
2	Abu Sayed Khudri Roman 	Frontend Developer 	•	Primary responsibilities 
•	Frontend development 
•	Page layout making
3	Amit Hasan Sadhin	Project Manager 	•	Primary responsibilities 
•	Planning for the project, analyzing the group mate’s suggestion, 
•	Resource Findings,

4	Hamzeh Wahed Bajbouj	UI/UX Designer 	•	Primary responsibilities 
•	Designing the User interfaces
•	User Experience
5	Almuhannad Darwesh	Database manager 	•	Primary responsibilities  
